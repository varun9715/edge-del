...
## Environments
- Preview: https://main--edge-del--varun9715.aem.page/
- Live: https://main--edge-del--varun9715.aem.live/
...
1. Open the `edge-del` directory in your favorite IDE and start coding :)
